...
namespace MorrowRim
{
	class JobGiver_HideFromAshStorm : ThinkNode_JobGiver
	{
		...
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			Region region = ClosestRegionWithinShelter(pawn.Position, pawn.Map, TraverseParms.For(pawn, Danger.Deadly, TraverseMode.ByPawn, false), RegionType.Set_Passable);
			if (region != null)
			{
